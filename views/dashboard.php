...
$recent_tasks = []; // Variable para tareas recientes
$error_message = '';

try {
    // --- Sección: Carga de Tareas Recientes ---
    ...
    $stmt_recent_tasks = $pdo->prepare("
        SELECT
            ...
            t.DashboardId -- Necesitamos el DashboardId para los enlaces de edición/eliminación
        FROM `Task` t
...
try {
    ...
    // error_log("Error al cargar áreas: " . $e->getMessage()); // Para depuración en logs
}
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-wrap items-start justify-start gap-4 mb-8">
        ...
        <a href="manage_dashboards.php" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Administrar Tableros</a>
    </div>
